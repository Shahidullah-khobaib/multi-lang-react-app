  ...
  ps: {
    translation: {
      ...
      hero: {
        ...
        subtitle: "د دغه آپلیکیشن په اړه مکمل معلومات همدی آپ کی شته. تاسو لاړ شئ او هغی ځای سخه مکمل هرسه زده کړئ. د تلو سخه یوه هیله ده چی ریپوزیټری ته درسره ستوری ورکړئ. مننه!",
      },
      guide: {
